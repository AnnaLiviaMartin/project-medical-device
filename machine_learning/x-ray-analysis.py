...
========================================
Schritt 1: Labels aufbereiten (One-Hot-Encoding)
Schritt 2: Patient-Level Split (kein Data Leakage)
Schritt 3: PyTorch Dataset & DataLoader
...
# ==============================================================================
# 2. LABELS AUFBEREITEN (One-Hot-Encoding)
# ==============================================================================
...
class NIHChestXrayDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        # Bild laden (Röntgen ist Graustufen → in RGB konvertieren für DenseNet)
        ...
        # Labels als Float-Tensor der Länge 14
        labels = torch.tensor(
...
def create_dataloaders(
    ...
    train_loader = DataLoader(
        ...
        shuffle=True,            # Training: shufflen für Zufälligkeit
...
# ==============================================================================
# 8. SCHNELLTEST (optional — läuft ohne echte Daten nicht durch)
# ==============================================================================

if __name__ == "__main__":
    DATA_DIR = "./data"  # ← Pfad zu deinen Daten anpassen

    train_loader, val_loader, test_loader, pos_weights = create_dataloaders(
        data_dir=DATA_DIR,
        batch_size=32,
        num_workers=4,
    )

    # Einen Batch inspizieren
